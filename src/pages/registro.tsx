    ...
    return (
        <div className="min-h-screen flex bg-[#8b8b8b] ">
            ...
            <div className="flex-grow flex justify-end">
                <div className="bg-[#0a1113] p-10 shadow-lg h-full w-8/12 ">
                ...
                <form>                    
                    <div className="text-white mb-4">
                        ...
                        <input
                            type="text"
                            id="name"
                            className="w-80 border rounded px-3 py-2 bg-[#c4e5ee]"
                            placeholder="Nome"
                        />
                    </div>
                    <div className="mb-4 text-white">
                        ...
                        <input
                            type="email"
                            id="email"
                            className="w-full border rounded px-3 py-2 bg-[#c4e5ee]"
